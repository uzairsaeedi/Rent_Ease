...
public class SuvCarFragment extends Fragment {
    ...
    Button btn_book;
    public SuvCarFragment() {
        // Required empty public constructor
    }

    public static SuvCarFragment newInstance() {
        SuvCarFragment fragment = new SuvCarFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_suv_car, container, false);
        ...
        DocumentReference documentReferenceSuv = db.collection("cars_suv").document(car_id);

        documentReferenceSuv.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
